...
exports.BoardOperations = void 0;
...
class BoardOperations {
    ...
    async openFile(node) {
        ...
        if (ws) {
            ...
            const temp = vscode.Uri.joinPath(vscode.workspace.workspaceFolders[0].uri.fsPath, node.path.replace(/\//g, "_"));
...
exports.BoardOperations = BoardOperations;
//# sourceMappingURL=boardOperations.js.map